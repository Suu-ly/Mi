  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full font-medium ring-offset-stone-50 text-slate-900 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-900 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:text-slate-400 [&_svg]:pointer-events-none [&_svg]:size-6 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-slate-200 hover:bg-slate-100 disabled:bg-slate-100",
